...
import { fetchRandomClaim } from '../api';
...
export const VerifyPage = ({
  ...
  const handleRandomClaim = async () => {
    try {
      const data = await fetchRandomClaim();

      if (data?.claim) {
        setClaimText(data.claim);
      }
    } catch (err) {
      console.error('Failed to fetch random claim:', err);
    }
  };
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {claimHistory.map((claim, index) => (
              <div
                key={index}
                className="p-3 bg-slate-900/50 border border-slate-800 rounded-xl text-xs text-slate-400 hover:border-slate-600 cursor-pointer transition-all truncate"
              >
                {claim}
              </div>
            ))}
        ...
        <section className="space-y-6">
          ...
          <div className="relative space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex flex-wrap gap-2 bg-slate-900 border border-slate-800 rounded-2xl p-1 shadow-inner">
                <button
                  onClick={() =>
              ...
              <button
                  ...
                  className="px-4 py-2 rounded-xl border border-slate-700 bg-slate-900 text-slate-300 hover:border-sky-500 hover:text-sky-400 transition-all text-sm font-bold"
                >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-sm text-slate-500 italic max-w-xl">
              Verification uses FEVER-trained DeBERTa models against
              Wikipedia evidence retrieval pipelines.
            </p>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                  ...
                  <div className="lg:col-span-2">
                    ...
                    <div className="mt-8 p-4 bg-emerald-500/5 rounded-xl border border-emerald-500/20 text-emerald-100 text-sm">
                      ...
                      The model predicted {result?.label} using the
                      retrieved evidence and verifier scores.
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="confidence-score italic mb-2 font-black">
                    ...
                    <div className="text-xs font-mono font-bold text-white tracking-wide block mb-4 pt-5 flex flex-col gap-1">
                      <span>
                        Entailment:{' '}
                        {result?.scores?.entailment?.toFixed(2)}
                      </span>
                      ...
                      <span>
                        Contradiction:{' '}
                        {result?.scores?.contradiction?.toFixed(2)}
                      </span>
                    </div>
                  </div>
              ...
              <section className="evidence-section space-y-8">
                <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                  <h2 className="text-2xl font-display font-black tracking-tighter text-white">
                    Evidence Trail
                  </h2>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mt-8 pt-8 border-t border-slate-800/50">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="font-black text-sm tracking-tighter font-mono text-slate-100">
                              {ev.score?.toFixed(3)}
                            </div>
