...
if __name__ == "__main__":
    input_file = "data/processed/wiki_targeted_subset.jsonl"
    index_file = "data/index/wiki_targeted_subset.index"
    metadata_file = "data/index/wiki_targeted_subset_metadata.json"
